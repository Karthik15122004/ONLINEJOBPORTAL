...
import {
  ...
  useDirection,
  usePrevious
} from "./chunk-5MOHVMX2.js";
import {
  useSize
} from "./chunk-77ITU37J.js";
import {
  Presence
} from "./chunk-GURP7A6R.js";
import {
  composeEventHandlers,
  useControllableState,
  useId
} from "./chunk-JREG2REF.js";
import {
  useCallbackRef
} from "./chunk-2JHERUAI.js";
import {
  composeRefs,
  useComposedRefs
...
var Radio = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime8.jsxs)(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
      ...
      isFormControl && (0, import_jsx_runtime8.jsx)(
        RadioBubbleInput,
        {
          control: button,
...
var RadioIndicator = React8.forwardRef(
  (props, forwardedRef) => {
    const { __scopeRadio, forceMount, ...indicatorProps } = props;
    const context = useRadioContext(INDICATOR_NAME, __scopeRadio);
    return (0, import_jsx_runtime8.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime8.jsx)(
      Primitive.span,
      {
...
var RadioBubbleInput = React8.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
var RadioGroupIndicator = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime9.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
